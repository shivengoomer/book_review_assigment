...
function BookFormInner() {
  ...
  return (
    <div className="mx-auto max-w-lg">
      <h1 className=" hover:text-red-600 mb-4 text-3xl font-semibold tracking-tight">
      ...
      <form onSubmit={handleSubmit} className="space-y-4 card p-6">
        ...
        <button className="btn-primary w-full bg-[#34656D] rounded-2xl py-2 text-white hover:bg-[#334443] font-bold">
          Save
        </button>
      </form>
    </div>
